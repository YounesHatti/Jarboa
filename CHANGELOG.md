...
- Attach Smack's OMEMO manager only after XMPP authentication so an encryption setup failure cannot abort login or disconnect an otherwise valid account session.
